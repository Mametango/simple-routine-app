# GitHub Repository Update Script for Moving Logout Button
# Move logout button from header to settings modal bottom

Write-Host "Starting GitHub repository update for moving logout button..." -ForegroundColor Green
...
$success = $success -and (Update-File "index.html" "Move logout button from header to settings modal bottom")
$success = $success -and (Update-File "styles.css" "Add CSS styles for logout section in settings modal")
...
if ($success) {
    ...
    Write-Host "Logout button has been moved to settings modal!" -ForegroundColor Green
} else {
