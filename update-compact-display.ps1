# GitHub Repository Update Script for Compact Routine Display
# Update files to show routines in a more compact 2-line format

Write-Host "Starting GitHub repository update for compact routine display..." -ForegroundColor Green
...
foreach ($file in $files) {
    ...
    try {
        ...
        $body = @{
            message = "Make routine display more compact (2 lines instead of 4)"
...
Write-Host "Routine display is now more compact!" -ForegroundColor Green 