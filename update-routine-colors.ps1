# GitHub Repository Update Script for Routine Title Color Fix
# Update styles.css with fixed colors for better readability

Write-Host "Starting GitHub repository update for routine title color fix..." -ForegroundColor Green
...
try {
    ...
    $body = @{
        message = "Fix routine title colors for better Japanese text visibility"
...
Write-Host "Routine titles should now be visible with Japanese text!" -ForegroundColor Green 